...
namespace viz::window
{
	...
	public:
		...
		HomeWindow(const sf::Vector2u &window_size, std::string title, std::function<void()> search_call_back, std::function<void()> sort_call_back, std::function<void()> exit_callback);
