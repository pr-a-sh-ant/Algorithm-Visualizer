...
namespace search_callbacks
{
	...
	void best_first(viz::window::SearchWindow &search_window)
	{
		search_window.selected_search_algorithm = search_window.search_algorithms["BestFirstSearch"];
		search_window.maze->clear();
		search_window.selected_search_algorithm->reset();
	}
...
void viz::window::SearchWindow::init_buttons()
{
	const std::vector<ButtonInfo> button_info = {
		...
		{{1500, 50}, {400, 80}, "Maze", {9, 57, 120}, {19, 98, 168}, search_callbacks::maze}, // Maze Button
		{{1500, 150}, {400, 80}, "Destination", {9, 57, 120}, {19, 98, 168}, search_callbacks::destination},
		// Destination Button
		...
		{{1350, 450}, {300, 80}, "Breadth First", {9, 57, 120}, {19, 98, 168}, search_callbacks::bfs},					 // BFS Button
		{{1350, 550}, {300, 80}, "Depth First", {9, 57, 120}, {19, 98, 168}, search_callbacks::dfs},					 // DFS Button
		{{1350, 650}, {300, 80}, "Best First", {9, 57, 120}, {19, 98, 168}, search_callbacks::best_first},					 // DFS Button
	...
	: Window(window_size, title), back_callback(std::move(back_callback))
{
	...
	this->search_algorithms = {
		...
		{"BestFirstSearch", new search::BestFirstSearch(this->search_space, 0.01f)}
	};
	...
	algorithm_text.setPosition(1350, 350);
}
